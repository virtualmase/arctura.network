...
const published = ["/", "/insights/", "/insights/train-your-agent/", "/tools/work-order/", "/records/2026-08/"];
const errors = [];
...
for (const route of ["/insights/", "/insights/train-your-agent/", "/tools/work-order/", "/records/2026-08/"]) if (!localLinks.has(route)) errors.push(`${route}: not reachable through a crawlable link`);
